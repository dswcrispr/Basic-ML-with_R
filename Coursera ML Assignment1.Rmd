...
```{r run gradient descent algorithm}
...
# 1.3.1 Visualizing J(theta_0, theta_1), Surface
```{r visual J}
...
```
# 1.3.2 Visualizing J(theta_0, theta_1), Contour
```{r contour}
