...
```
    ...
    ## [1] "Gradient for initial thetas: -15.220, 598.251"
...
![](Coursera_ML_Assginment5_files/figure-markdown_github-ascii_identifiers/fitted-1.png)
...
Then, Compute error vectors with error\_train and error\_val
...
![](Coursera_ML_Assginment5_files/figure-markdown_github-ascii_identifiers/learncurve1-1.png)
...
Use 'polyFeature' function to return X\_p matrix(m by p) which contains polynomials of X as its columns.
...
![](Coursera_ML_Assginment5_files/figure-markdown_github-ascii_identifiers/fitline-1.png)

Display polynomial learning curve

First, Compute error vectors with error\_train and error\_val
...
![](Coursera_ML_Assginment5_files/figure-markdown_github-ascii_identifiers/polycurve-1.png)
